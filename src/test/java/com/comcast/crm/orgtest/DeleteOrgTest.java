...
import com.comcastcCRM_ObjectRepositooryUtility.CreatingNewOragnizationpage;
import com.comcastcCRM_ObjectRepositooryUtility.Homepage;
import com.comcastcCRM_ObjectRepositooryUtility.Loginpage;
import com.comcastcCRM_ObjectRepositooryUtility.OrganizationInfopage;
import com.comcastcCRM_ObjectRepositooryUtility.Organizationspage;
...
public class DeleteOrgTest 
{
	public static void main(String[] args) throws IOException, InterruptedException {
	    ...
	    cnop.getOrgnamedt().sendKeys(orgname);
	  //  wlib.selectdd(cnop.,actorgname);
